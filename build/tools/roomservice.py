...
custom_local_manifest = ".repo/local_manifests/zap_manifest.xml"
custom_default_revision = "thirteen"
custom_dependencies = "zap.dependencies"
org_manifest = "zap"  # leave empty if org is provided in manifest
org_display = "ZAP"  # needed for displaying
